...
2. **Największy postęp** między początkiem poprzedniego sezonu i począkiem tego sezonu wykonały **Alfa Romeo (Sauber)** i **Toro Rosso**
...
Sezon jeszcze długi i wiele może się zmieniać, ale jeśli chodzi o tempo kwalifikacyjne zespółów na rozpoczęcie sezonu, to coś już wiemy, w przeciwieństwie do sytuacji po testach i treningach. Jak słusznie zauważył Christian Horner, szef Red Bull Racing, w przeciwieństwie do testów i treningów na czasówkę każdy uczciwie ściąga spodnie i pokazuje co ma[^1].
...
Wydaje się też, że Red Bull zbliżył się do Ferrari, choć to może być "efekt Maxa". Na to, co zrobił Gasly odpadając w Q1, spuśćmy zasłonę milczenia, choć mógł być to też błąd zespołu.

## Alfa Romeo (Sauber) i Toro Rosso z największą poprawą do poprzednich kwalifikacji GP Australii
